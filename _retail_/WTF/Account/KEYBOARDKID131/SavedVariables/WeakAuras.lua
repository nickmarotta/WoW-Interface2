...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Runic Affinity Assignment List"] = {
			...
			["displayText_format_p_time_format"] = 0,
			["customTextUpdate"] = "event",
			["url"] = "https://wago.io/2JThfnb9V/13",
			["actions"] = {
				["start"] = {
				},
				["init"] = {
	...
	["lastUpgrade"] = 1619734856,
	["dbVersion"] = 45,
	["clearOldHistory"] = 30,
	["registered"] = {
	},
	["frame"] = {
		["xOffset"] = -653.1309814453125,
		["yOffset"] = -149.912109375,
