...
BugGrabberDB = {
	...
	["errors"] = {
		...
		{
			["message"] = "[ADDON_ACTION_BLOCKED] AddOn 'MRT' tried to call the protected function '<unnamed>:Hide()'.",
			["time"] = "2022/03/17 21:36:43",
			["stack"] = "[string \"@Interface\\AddOns\\!BugGrabber\\BugGrabber.lua\"]:519: in function <Interface\\AddOns\\!BugGrabber\\BugGrabber.lua:519>\n[string \"=[C]\"]: in function `Hide'\n[string \"@Interface\\AddOns\\MRT\\RaidCheck.lua\"]:3581: in function <Interface\\AddOns\\MRT\\RaidCheck.lua:3576>\n[string \"@Interface\\SharedXML\\C_TimerAugment.lua\"]:16: in function <Interface\\SharedXML\\C_TimerAugment.lua:14>",
			["session"] = 1729,
			["counter"] = 1,
		}, -- [24]
		{
			["message"] = "...dOns\\BigWigs_SepulcherOfTheFirstOnes\\AnduinWrynn.lua:369: attempt to perform arithmetic on a nil value",
			["time"] = "2022/03/24 23:24:39",
			["locals"] = "Skipped (In Encounter)",
			["stack"] = "[string \"@Interface\\AddOns\\BigWigs_SepulcherOfTheFirstOnes\\AnduinWrynn.lua\"]:369: in function `?'\n[string \"@Interface\\AddOns\\BigWigs_Core\\BossPrototype.lua\"]:541: in function <Interface\\AddOns\\BigWigs_Core\\BossPrototype.lua:507>",
			["session"] = 1733,
			["counter"] = 1,
		}, -- [25]
		{
			["message"] = "...dOns\\BigWigs_SepulcherOfTheFirstOnes\\AnduinWrynn.lua:436: attempt to index field '?' (a nil value)",
			["time"] = "2022/03/24 23:23:24",
			["locals"] = "Skipped (In Encounter)",
			["stack"] = "[string \"@Interface\\AddOns\\BigWigs_SepulcherOfTheFirstOnes\\AnduinWrynn.lua\"]:436: in function `?'\n[string \"@Interface\\AddOns\\BigWigs_Core\\BossPrototype.lua\"]:541: in function <Interface\\AddOns\\BigWigs_Core\\BossPrototype.lua:507>",
			["session"] = 1733,
			["counter"] = 3,
		}, -- [26]
		{
			["message"] = "[string \"Error in: ZenTracker (ZT) Main':'initializa...\"]:1575: attempt to compare nil with number",
			["time"] = "2022/03/24 23:27:17",
			["stack"] = "[string \"Error in: ZenTracker (ZT) Main':'initialization\"]:1126: in function `handle'\n[string \"Error in: ZenTracker (ZT) Main\"]:2: in function <[string \"Error in: ZenTracker (ZT) Main\"]:1>\n[string \"=[C]\"]: in function `xpcall'\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:611: in function <Interface\\AddOns\\WeakAuras\\GenericTrigger.lua:537>\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:747: in function `ScanEventsInternal'\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:708: in function `ScanEvents'\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:2284: in function `CheckSpellCooldown'\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:2295: in function `CheckSpellCooldows'\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:2422: in function `CheckCooldownReady'\n[string \"@Interface\\AddOns\\WeakAuras\\GenericTrigger.lua\"]:1948: in function <Interface\\AddOns\\WeakAuras\\GenericTrigger.lua:1942>",
			["session"] = 1733,
			["counter"] = 4,
		}, -- [27]
		{
		...
		{
			["message"] = "[ADDON_ACTION_BLOCKED] AddOn 'DominationSocketHelper' tried to call the protected function '<unnamed>:Hide()'.",
			["time"] = "2022/04/01 00:06:34",
			["stack"] = "[string \"@Interface\\AddOns\\!BugGrabber\\BugGrabber.lua\"]:519: in function <Interface\\AddOns\\!BugGrabber\\BugGrabber.lua:519>\n[string \"=[C]\"]: in function `Hide'\n[string \"@Interface\\AddOns\\DominationSocketHelper\\main.lua\"]:803: in function `CHARACTER_FRAME_HIDE_GBC'\n[string \"@Interface\\AddOns\\DominationSocketHelper\\main.lua\"]:61: in function <Interface\\AddOns\\DominationSocketHelper\\main.lua:61>",
			["session"] = 1738,
			["counter"] = 1,
		}, -- [29]
		{
			["message"] = "[ADDON_ACTION_BLOCKED] AddOn 'Prat-3.0-3.9.1' tried to call the protected function 'GetPlaystyleString()'.",
			["time"] = "2022/04/08 14:41:23",
			["stack"] = "[string \"@Interface\\AddOns\\!BugGrabber\\BugGrabber.lua\"]:519: in function <Interface\\AddOns\\!BugGrabber\\BugGrabber.lua:519>\n[string \"=[C]\"]: in function `GetPlaystyleString'\n[string \"@Interface\\FrameXML\\LFGList.lua\"]:1011: in function `LFGListEntryCreation_OnPlayStyleSelected'\n[string \"@Interface\\FrameXML\\LFGList.lua\"]:720: in function `LFGListEntryCreation_Select'\n[string \"@Interface\\FrameXML\\LFGList.lua\"]:1200: in function `LFGListEntryCreation_SetEditMode'\n[string \"@Interface\\FrameXML\\LFGList.lua\"]:648: in function `LFGListEntryCreation_Show'\n[string \"@Interface\\FrameXML\\LFGList.lua\"]:579: in function <Interface\\FrameXML\\LFGList.lua:567>",
			["session"] = 1742,
			["counter"] = 1,
		}, -- [30]
		{
