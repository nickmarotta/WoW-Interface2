...
ConsolePortUIFrames = {
	["Blizzard_GarrisonUI"] = {
		"BFAMissionFrame", -- [1]
		"GarrisonBuildingFrame", -- [2]
		"GarrisonCapacitiveDisplayFrame", -- [3]
		"GarrisonLandingPage", -- [4]
		"GarrisonMissionFrame", -- [5]
		"GarrisonMonumentFrame", -- [6]
		"GarrisonRecruiterFrame", -- [7]
		"GarrisonShipyardFrame", -- [8]
		"OrderHallMissionFrame", -- [9]
		"OrderHallTalentFrame", -- [10]
	},
	...
	["ConsolePort"] = {
		...
		"QuestFrame", -- [43]
		nil, -- [44]
		"QuestLogPopupDetailFrame", -- [45]
		"RecruitAFriendFrame", -- [46]
		"ReadyCheckFrame", -- [47]
		"SpellBookFrame", -- [48]
		"SplashFrame", -- [49]
		"StackSplitFrame", -- [50]
