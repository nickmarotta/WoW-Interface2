    ...
    if barType=="bar" then
        ...
        if b.skinreset then
            ...
            if Healbot_Config_Skins.BarCol[Healbot_Config_Skins.Current_Skin][b.frame]["BORDER"]>1 then
                ...
                if testBarsOn then
                    b.gref["BackBorder"]:SetBackdropBorderColor(1, 1, 1, 1)
                else
        ...
        if b.text.reset then
            ...
            for x=1,9 do
                ...
                if Healbot_Config_Skins.AuxBar[Healbot_Config_Skins.Current_Skin][x][b.frame]["ANCHOR"]<3 then
...
function HealBot_Skins_Check_Skin(SkinName, fromImport)
    ...
    if not Healbot_Config_Skins.General[SkinName]["HBDIMMING"] then Healbot_Config_Skins.General[SkinName]["HBDIMMING"]=4 end
